...
const DRangePicker = (props) => {
    console.log(props.data,"values of props")
  return (
    <div>
        <div className="h-12 lg:h-14 w-44 lg:w-48 bg-white relative border-2 border-button_border text-orange rounded-lg">
                  
                  <div className="w-full">
                    <DatePicker
                      className="text-sm w-40 lg:w-44 pt-4 placeholder:text-orange"
                      id="datepicker"
                      selected={props.data.start}
